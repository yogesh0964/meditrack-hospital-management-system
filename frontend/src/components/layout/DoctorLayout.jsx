  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      <aside className="w-64 bg-emerald-700 text-white flex flex-col">
        <div className="px-6 py-5 text-2xl font-bold border-b border-emerald-600">
          MediTrack
        </div>
        ...
        <div className="p-3 border-t border-emerald-600">
          <button
            ...
            className="flex items-center gap-3 px-3 py-2 w-full rounded-lg hover:bg-emerald-600 transition"
          >
            <LogOut size={18} />
            <span>Logout</span>
          </button>
